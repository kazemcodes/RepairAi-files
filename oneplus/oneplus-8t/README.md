# oneplus OnePlus 8T - Boardview Files
...
node src/index.js boardview-convert \
  --input path/to/oneplus-8t.brd \
  --output ../oneplus/oneplus-8t/boardview
```
...
### Google Searches
- [oneplus OnePlus 8T boardview](https://www.google.com/search?q=oneplus%20OnePlus%208T%20boardview)
- [oneplus OnePlus 8T schematic](https://www.google.com/search?q=oneplus%20OnePlus%208T%20schematic)

### GitHub Repositories
- [Search GitHub](https://github.com/search?q=oneplus%20OnePlus%208T%20boardview&type=repositories)
