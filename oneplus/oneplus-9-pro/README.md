# oneplus OnePlus 9 Pro - Boardview Files
...
node src/index.js boardview-convert \
  --input path/to/oneplus-9-pro.brd \
  --output ../oneplus/oneplus-9-pro/boardview
```
...
### Google Searches
- [oneplus OnePlus 9 Pro boardview](https://www.google.com/search?q=oneplus%20OnePlus%209%20Pro%20boardview)
- [oneplus OnePlus 9 Pro schematic](https://www.google.com/search?q=oneplus%20OnePlus%209%20Pro%20schematic)

### GitHub Repositories
- [Search GitHub](https://github.com/search?q=oneplus%20OnePlus%209%20Pro%20boardview&type=repositories)
