# huawei Nova 11 - Boardview Files
...
node src/index.js boardview-convert \
  --input path/to/nova-11.brd \
  --output ../huawei/nova-11/boardview
```
...
### Google Searches
- [huawei Nova 11 boardview](https://www.google.com/search?q=huawei%20Nova%2011%20boardview)
- [huawei Nova 11 schematic](https://www.google.com/search?q=huawei%20Nova%2011%20schematic)

### GitHub Repositories
- [Search GitHub](https://github.com/search?q=huawei%20Nova%2011%20boardview&type=repositories)
