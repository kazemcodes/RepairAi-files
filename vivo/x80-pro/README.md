...
node src/index.js boardview-convert \
  --input path/to/x80-pro.brd \
  --output ../vivo/x80-pro/boardview
```
...
### Google Searches
- [vivo X80 Pro boardview](https://www.google.com/search?q=vivo%20X80%20Pro%20boardview)
- [vivo X80 Pro schematic](https://www.google.com/search?q=vivo%20X80%20Pro%20schematic)

### GitHub Repositories
- [Search GitHub](https://github.com/search?q=vivo%20X80%20Pro%20boardview&type=repositories)
