...
node src/index.js boardview-convert \
  --input path/to/v23.brd \
  --output ../vivo/v23/boardview
```
...
### Google Searches
- [vivo V23 boardview](https://www.google.com/search?q=vivo%20V23%20boardview)
- [vivo V23 schematic](https://www.google.com/search?q=vivo%20V23%20schematic)

### GitHub Repositories
- [Search GitHub](https://github.com/search?q=vivo%20V23%20boardview&type=repositories)
