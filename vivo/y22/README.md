...
node src/index.js boardview-convert \
  --input path/to/y22.brd \
  --output ../vivo/y22/boardview
```
...
### Google Searches
- [vivo Y22 boardview](https://www.google.com/search?q=vivo%20Y22%20boardview)
- [vivo Y22 schematic](https://www.google.com/search?q=vivo%20Y22%20schematic)

### GitHub Repositories
- [Search GitHub](https://github.com/search?q=vivo%20Y22%20boardview&type=repositories)
