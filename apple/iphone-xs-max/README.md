# apple iPhone XS Max - Boardview Files
...
node src/index.js boardview-convert \
  --input path/to/iphone-xs-max.brd \
...
### GitHub Repositories
- [Search GitHub](https://github.com/search?q=apple%20iPhone%20XS%20Max%20boardview&type=repositories)
