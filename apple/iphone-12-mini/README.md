# apple iPhone 12 Mini - Boardview Files
...
node src/index.js boardview-convert \
  --input path/to/iphone-12-mini.brd \
  --output ../apple/iphone-12-mini/boardview
```
...
### Google Searches
- [apple iPhone 12 Mini boardview](https://www.google.com/search?q=apple%20iPhone%2012%20Mini%20boardview)
- [apple iPhone 12 Mini schematic](https://www.google.com/search?q=apple%20iPhone%2012%20Mini%20schematic)

### GitHub Repositories
- [Search GitHub](https://github.com/search?q=apple%20iPhone%2012%20Mini%20boardview&type=repositories)
