# apple iPhone 13 Mini - Boardview Files
...
node src/index.js boardview-convert \
  --input path/to/iphone-13-mini.brd \
...
### GitHub Repositories
- [Search GitHub](https://github.com/search?q=apple%20iPhone%2013%20Mini%20boardview&type=repositories)
